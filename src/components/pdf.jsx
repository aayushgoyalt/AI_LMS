...
const SamplePage = () => {
  ...
  const availablePDFs = [
    { id: 1, name: 'Sample PDF 1', pages: 10, url: 'https://example.com/sample-pdf-1.pdf' },
    { id: 2, name: 'Sample PDF 2', pages: 15, url: 'https://example.com/sample-pdf-2.pdf' },
    { id: 3, name: 'Sample PDF 3', pages: 20, url: 'https://example.com/sample-pdf-3.pdf' },{ id: 3, name: 'Sample PDF 3', pages: 20, url: 'https://example.com/sample-pdf-3.pdf' },
  ...
  return (
    <div class="fixed bg-[#080e215f] h-[100vh] w-[25vw] backdrop-blur-lg rounded-lg shadow-lg p-6 right-0">
      ...
      <div class="rounded-lg overflow-scrool border border-gray-300/75">
